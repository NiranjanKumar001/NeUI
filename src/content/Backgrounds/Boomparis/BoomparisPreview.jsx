...
import './BoomparisPreview.css';

gsap.registerPlugin(CustomEase);

const BoomparisPreview = () => {
    ...
    tl.to(heroRef.current, {
      ...
      onStart: () => {
        gsap.to(progressBarRef.current, {
          width: "100%", // Changed from 100vw to 100% for preview
          duration: 2,
          ease: customEase,
        });
  ...
  return (
    <div className="boomparis-preview">
...
export default BoomparisPreview;
